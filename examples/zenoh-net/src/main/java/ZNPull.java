...
class ZNPull implements Runnable {
    ...
    @Option(names = {"-s", "--selector"},
        description = "The selector to be used for issuing the pull subscription. [default: ${DEFAULT-VALUE}]")
    ...
    public static void main(String[] args) {
        int exitCode = new CommandLine(new ZNPull()).execute(args);
