...
public class ZQuerier(initialPtr: Long) : AutoCloseable {
    ...
    public fun zQuerierGet(parameters: String?, payload: Any?, encoding: Any, attachment: Any?, callback: ZReplyCallback, onClose: Callback) {
        synchronized(this) {
            ...
            JNINative.zQuerierGet(querier_ptr, parameters, payload, encoding, attachment, callback, onClose)
        } else {
            JNINative.zQuerierGet(querier_ptr, parameters, payload, encoding, attachment, callback, onClose)
        }
        } else {
