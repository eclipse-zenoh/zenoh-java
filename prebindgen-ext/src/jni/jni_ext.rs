...
impl JniExt {
    ...
    pub fn opaque_handle(
        ...
        // Keep legacy `kotlin_type_fqns` view in sync so existing
        // readers (emit_into_dispatcher, jni_kotlin_ext) keep working.
    ...
    pub fn input_decoder(
        ...
        let entry = self.types.entry(key).or_default();
