...
data class Timestamp(
    ...
    internal fun toJni(): JniTimestamp = JniTimestamp(ntp64, id.inner.bytes)
    ...
    companion object {
        ...
        internal fun fromJni(t: JniTimestamp): Timestamp =
            Timestamp(t.ntp64, ZenohId(JniZenohId(t.id)))
    }
}
