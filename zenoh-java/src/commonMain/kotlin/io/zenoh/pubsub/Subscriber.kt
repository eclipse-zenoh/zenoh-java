...
sealed class Subscriber(
    val keyExpr: KeyExpr, private var jniSubscriber: JniZSubscriber?
 ...
 * ```
 */
class CallbackSubscriber internal constructor(keyExpr: KeyExpr, jniSubscriber: JniZSubscriber?): Subscriber(keyExpr, jniSubscriber)
 ...
 */
class HandlerSubscriber<R> internal constructor(keyExpr: KeyExpr, jniSubscriber: JniZSubscriber?, val receiver: R): Subscriber(keyExpr, jniSubscriber)
