...
class ConfigTest {
    ...
    fun configLoadsJsonTest() {
        ...
        val sessionClient = Session.open(Config.from(clientCfg))
        val sessionServer = Session.open(Config.from(serverCfg))
        var receivedSample: Sample? = null
        val subscriber = sessionClient.declareSubscriber(TEST_KEY_EXP).with { sample -> receivedSample = sample }.res()
