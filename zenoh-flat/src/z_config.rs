...
#[prebindgen]
pub fn z_config_from_file(path: &String) -> Result<ZConfig, Error> {
...
#[prebindgen]
pub fn z_config_from_json(s: &String) -> Result<ZConfig, Error> {
    z_config_from_json5(s)
}

/// Parse a configuration from a JSON5-formatted string.
#[prebindgen]
pub fn z_config_from_json5(s: &String) -> Result<ZConfig, Error> {
...
#[prebindgen]
pub fn z_config_from_yaml(s: &String) -> Result<ZConfig, Error> {
...
#[prebindgen]
pub fn z_config_get_json(c: &ZConfig, key: &String) -> Result<String, Error> {
    Ok(c.get_json(key)?)
}

/// Insert a JSON5-formatted value at `key` in the configuration.
#[prebindgen]
pub fn z_config_insert_json5(c: &mut ZConfig, key: &String, value: &String) -> Result<(), Error> {
